        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            <h1 className="text-5xl font-semibold tracking-tight text-balance text-gray-900 dark:text-gray-100 sm:text-7xl">
              Scratch ユーザーのための、あなた専用プロフィールページ
            </h1>
            <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
              Scratch
              ユーザーが自分のプロフィールページを簡単に作成できるサービスです。Scratch
              のアカウントと連携し、活動情報や自己紹介、制作したプロジェクトなどをまとめて表示できます。個性を表現するカスタマイズ機能も搭載し、より魅力的なプロフィールページを作成できます。
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              >
                詳細はこちら <span aria-hidden="true">→</span>
              </a>
            </div>
          </div>
        </div>
